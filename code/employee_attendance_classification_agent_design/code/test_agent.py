...
from agent import EmployeeAttendanceClassificationAgentAgent

class TestEmployeeAttendanceClassificationAgentAgent:
    
    @pytest.fixture
    def agent(self):
        return EmployeeAttendanceClassificationAgentAgent()
